...
#        output_3 = cv2.fastNlMeansDenoisingColored(output_3,None,6,6,7,21)
        ...
        text = pytesseract.image_to_string(Image.open('/home/caratred/enhancement.jpeg'),lang='hin+mal+tel+tam+sat+ben+kan+ori+pan+guj+mni+eng',config='--psm 11')
        print("text:",text)


enhance("/home/caratred/Downloads/squared/aadhaar/2019-05-07 16:01:25.829894.jpg")