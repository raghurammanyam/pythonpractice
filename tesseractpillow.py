...
def preprocess_image_using_pil(image_path):
    ...
    img.save("/home/caratred/input-black.gif")

    #   Make the image bigger (needed for OCR)
    basewidth = 1000  # in pixels
    im_orig = Image.open('/home/caratred/input-black.gif')
    ...
    ext = ".tif"
    tif_file = "/home/caratred/input-NEAREST.tif"
    big.save(tif_file)
...
def binarize_image_using_pil(captcha_path, binary_image_path='/home/caratred/input-black-n-white.gif'):
...
def binarize_image_using_opencv(captcha_path, binary_image_path='/home/caratred/input-black-n-white.jpg'):
...
if __name__ == "__main__":
    print (get_captcha_text_from_captcha_image("/home/caratred/Downloads/drivers/224.jpg")) 