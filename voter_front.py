...
def detect_text(image_file):
    try:
        ...
        print(data,"final")
        json_data = {"uid":id,"name":person_name,"sex":sex,"Date_of_birth":date_of_birth,"image":image_file}
        print(json_data)
        return json_data
...
data=[]
for root, dirs, files in os.walk("/home/raghu/Pictures/voterfront"):
        for filename in files:
             abc=detect_text(root+"/"+filename)
             data.append(abc)
# #print(address)
with open('/home/raghu/voterfrontktest.txt','w') as f:
    f.write(str(data))
